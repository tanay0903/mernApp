...
const resetpassword = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen px-6 bg-gradient-to-br from-blue-200 to-purple-400">
      ...
      {/* EMAIL INPUT FORM */}
      {!isEmailSent &&
      <form onSubmit={onSubmitEmail} className='bg-slate-900 p-8 roundeed-lg shadow-lg w-96 text-sm' >
      ...
      <form onSubmit={onSubmitOTP} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
        ...
        <button className='w-full py-3 bg-gradient-to-r from-indigo-500 to-indigo-950 text-white rounded-full'>
          Submit
        </button>
      </form>
      }
      ...
      {isOtpSubmitted && isEmailSent &&
      <form onSubmit={onSubmitNewPassword} className='bg-slate-900 p-8 roundeed-lg shadow-lg w-96 text-sm' >
